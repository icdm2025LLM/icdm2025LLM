...
class QlearningOracle:
    """
    Oracle using tabular Q-learning to learn optimal behavior.
    """
    ...
    def _get_state_key(self, env):
        """
        Create a hashable state key from environment.
        """
        return (
            env.agent_pos,
            env.agent_dir,
    ...
    def get_action(self, env):
        """
        Get action using epsilon-greedy exploration policy.
        """
