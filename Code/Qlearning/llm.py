...
class CalibratedBERT(nn.Module):
    """
    Calibrated BERT model for action prediction with uncertainty estimation (MC Dropout).
    """
    ...
    def predict(self, prompt):
        """
        Standard (no dropout) prediction — returns softmax probabilities.
        """
        self.eval()
    ...
    def mc_predict(self, prompt):
        """
        Monte Carlo (dropout-enabled) prediction for uncertainty estimation.
        Returns: (average probs, normalized uncertainty score)
        """
