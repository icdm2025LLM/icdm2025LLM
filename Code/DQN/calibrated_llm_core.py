...
class GRPOPolicy(nn.Module):
    ...
    def train(self, num_episodes=1000):
        ...
        with open(log_path, mode='w', newline='') as file:
            ...
            writer.writerow(["episode", "reward", "length", "key_picked", "door_opened", "goal_reached"])
        ...
        for episode in range(num_episodes):
            ...
            while not done:
                ...
                self.dqn_agent.store_transition(state_vector, action, reward, next_state_vector, done or truncated)
